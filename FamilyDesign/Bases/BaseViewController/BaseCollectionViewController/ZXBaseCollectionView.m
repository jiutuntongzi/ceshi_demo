...
@implementation ZXBaseCollectionView
...
- (id)dequeueReusableCellWithReuseIdentifier:(NSString *)identifier forIndexPath:(NSIndexPath *)indexPath {
    ...
    if ([cell isKindOfClass:[ZXBaseCollectionViewCell class]]) {
        [(ZXBaseCollectionViewCell *)cell setIndexPath:indexPath];
    }
    return cell;
}
...
- (id)dequeueReusableSupplementaryViewOfKind:(NSString *)elementKind withReuseIdentifier:(NSString *)identifier forIndexPath:(NSIndexPath *)indexPath {
    ...
    if ([cell isKindOfClass:[ZXBaseCollectionReusableView class]]) {
        [(ZXBaseCollectionReusableView *)cell setIndexPath:indexPath];
    }
    return cell;
}
